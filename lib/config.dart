const APP_NAME = 'Momona Healthcare';
//const APP_NAME = 'MHC';
const APP_FIRST_NAME = 'Momona';
const APP_SECOND_NAME = 'Healthcare';
const APP_NAME_TAG_LINE = 'Bringing Healthcare To Homes';
...
var COPY_RIGHT_TEXT = '© ${DateTime.now().year}. Made with ♡ by Momona Healthcare';
...
const ONESIGNAL_APP_ID = 'dd5441fa-b17e-4436-94b6-35b54b49a4dd'; //Your ONESIGNAL_APP_ID ; dd5441fa-b17e-4436-94b6-35b54b49a4dd
const ONESIGNAL_REST_API_ID = 'ODY2YWQyZTUtNWRmOS00NGNlLTlkNTItYWM0ODgwMjgyMGU5'; //ONESIGNAL_REST_API_ID; ODY2YWQyZTUtNWRmOS00NGNlLTlkNTItYWM0ODgwMjgyMGU5
const ONESIGNAL_CHANNEL_ID = 'a45d2167-6450-4db2-89a7-2a2a81f86a0d'; //Your ONESIGNAL_CHANNEL_ID;a45d2167-6450-4db2-89a7-2a2a81f86a0d
